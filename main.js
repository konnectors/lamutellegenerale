...
class LaMutuelleGeneraleContentScript extends cozy_clisk_dist_contentscript__WEBPACK_IMPORTED_MODULE_0__.ContentScript {
  ...
  getMonthReimbursments(element, billsInfos) {
    ...
    const currentMonth = element
      ...
      .textContent.trim()
      .replace('  ', ' ')
    const parsedDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(currentMonth, 'MMMM yyyy', new Date(), {
      locale: date_fns_locale__WEBPACK_IMPORTED_MODULE_4__["default"]
    })
    const formattedDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(parsedDate, 'yyyy-MM')
